class Ohm:
    ...
    def Resistance(voltage, intensity):
        ...
        """
        if ((isinstance(intensity, int) or isinstance(intensity, float)) and (
                isinstance(voltage, int) or isinstance(voltage, float))):
    ...
    def Voltage(intensity, resistance):
        ...
        """
        if ((isinstance(intensity, int) or isinstance(intensity, float)) and (
                isinstance(resistance, int) or isinstance(resistance, float))):
    ...
    def Intensity(voltage, resistance):
        ...
        """
        if ((isinstance(voltage, int) or isinstance(voltage, float)) and (
                isinstance(resistance, int) or isinstance(resistance, float))):
